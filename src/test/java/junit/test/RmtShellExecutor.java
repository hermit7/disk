...
public class RmtShellExecutor {
	private static final Logger lg = LoggerFactory.getLogger(RmtShellExecutor.class);
	...
	public static void main(String[] args) {
		RmtShellExecutor.execCmd("/bin/sh /root/myshell/report.sh >> /root/report.txt", "root", "123456",
				"192.168.137.30", 22, "/root/report.txt");
	}
}
