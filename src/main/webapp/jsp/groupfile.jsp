...
<body>
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="javascript:void(0)"
				onclick="listGroupShare('${groupNumber}')">${groupName}</a></li>
		</ul>
	</div>
	<div class="tools">
		<ul class="toolbar">
	...
	<script type="text/javascript">
		...
		function listGroupShare(groupNumber) {
		...
		function deleteShare(groupNumber, shareId) {
			console.log(groupNumber);
			console.log(shareId);
			$.messager.confirm('确认', '您确认想要删除此分享？', function(r) {
				if (r) {
					$.ajax({
						url : "${basePath}/share/deleteGroupShare.action",
						type : "POST",
						data : {
